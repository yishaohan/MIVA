...
class CrossAttnDownBlock3D(nn.Module):
    ...
    def forward(self, hidden_states, temb=None, encoder_hidden_states=None, attention_mask=None, attention_store=None):
        output_states = ()
        ...
        for resnet, attn, motion_module in zip(self.resnets, self.attentions, self.motion_modules):
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states = resnet(hidden_states, temb)
                hidden_states = attn(hidden_states, encoder_hidden_states=encoder_hidden_states, attention_store = attention_store, location = "down").sample
    ...
    def forward(
        ...
        for resnet, attn, motion_module in zip(self.resnets, self.attentions, self.motion_modules):
            ...
            if self.training and self.gradient_checkpointing:
                ...
                hidden_states = resnet(hidden_states, temb)
                hidden_states = attn(hidden_states, encoder_hidden_states=encoder_hidden_states, attention_store=attention_store, location = "up" ).sample
